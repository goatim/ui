...
import { Asset, Club, Player, Spotlight, SpotlightType } from '@goatim/client';
import { SpotlightThumbnail, SpotlightThumbnailSize } from '../../../src';
...
function Template({ type, size }: Props) {
  return <App type={type} size={size} />;
}
